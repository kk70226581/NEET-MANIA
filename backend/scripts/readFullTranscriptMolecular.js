...
try {
  ...
  if (lastUserLine) {
    ...
    const outputPath = 'c:\\Users\\karan\\OneDrive\\Desktop\\NEET\\NEETP\\backend\\scripts\\molecular_basis_raw.txt';
    fs.writeFileSync(outputPath, lastUserLine.content);
    console.log(`Saved raw molecular basis questions to ${outputPath}`);
  } else {
