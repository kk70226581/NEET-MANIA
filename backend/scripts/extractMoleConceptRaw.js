...
try {
  ...
  if (lastUserLine) {
    ...
    const outputPath = 'c:\\Users\\karan\\OneDrive\\Desktop\\NEET\\NEETP\\backend\\scripts\\mole_concept_raw.txt';
    fs.writeFileSync(outputPath, lastUserLine.content);
    console.log(`Saved raw mole concept questions to ${outputPath}`);
  } else {
