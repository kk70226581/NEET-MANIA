...
try {
  ...
  if (lastUserLine) {
    ...
    const outputPath = 'c:\\Users\\karan\\OneDrive\\Desktop\\NEET\\NEETP\\backend\\scripts\\raw_biotech_app_script.py';
    fs.writeFileSync(outputPath, lastUserLine.content);
    console.log(`Saved raw biotech app script to ${outputPath}`);
  } else {
