...
async function run() {
  try {
    ...
    const filePath = 'C:\\Users\\karan\\.gemini\\antigravity\\brain\\06514d81-d498-44fe-b71c-0999cfcf4fd7\\scratch\\questions_improved.json';
    ...
    for (const res of improvedQuestions) {
      ...
      const updateData = {
        ...
        'pyq.isPYQ': isPYQ,
        'pyq.year': isPYQ ? 2023 : null, // Default year if PYQ
