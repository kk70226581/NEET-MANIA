...
try {
  ...
  if (lastUserLine) {
    ...
    const outputPath = 'c:\\Users\\karan\\OneDrive\\Desktop\\NEET\\NEETP\\backend\\scripts\\units_and_measurements_raw.txt';
    fs.writeFileSync(outputPath, lastUserLine.content);
    console.log(`Saved raw untruncated content to ${outputPath}`);
  } else {
